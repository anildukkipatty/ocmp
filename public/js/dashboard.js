(function($) {
  ...
  $(document).ready(function() {
    if ($.fn.plot) {
      ...
      // DONUT
      var dataPie = [{
        label: "NSE Validating Nodes",
        data: 5
      }, {
        label: "Bank Relay Nodes",
        data: 3
      }, {
        label: "Nodeless Network Participants",
        data: 6
      }];
...
if (Gauge) {
  ...
  var gauge = window.gauge = new Gauge(target).setOptions(opts); // create sexy gauge!
